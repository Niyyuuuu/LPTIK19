...
@section('content')
    <div class="container mt-5">
        <h1 class="text-white fw-bold">Create New FAQ Entry</h1>

        <div class="card mt-4">
            <div class="card-header bg-primary">
                <h5 class="text-white mb-0">Add FAQ for Category: {{ $category->name }}</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('faq.entry.store', $category->id) }}" method="POST">
                    @csrf
                    <div class="mb-3">
