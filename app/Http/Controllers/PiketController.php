    ...
    public function piket(Request $request)
{
    ...
    public function processTicket($id)
    {
        ...
        // Ambil pengguna dengan role "Technician" atau "Piket"
    ...
    public function assignTechnician(Request $request, $id)
    {
        ...
        $pesan = "👨‍🔧 *Teknisi/Piket Ditugaskan*\n\n";
        $pesan .= "*No. Tiket:* {$ticketNumber}\n";
        $pesan .= "🔖 *Subjek:* {$cleanSubjek}\n";
        $pesan .= "🛠️ *Teknisi/Piket:* {$technician->name}\n";
        ...
        return redirect()->route('tickets')->with('success', 'Technician or Piket assigned successfully!');
    }
        ...
        {
            $ratingticket = Tiket::whereNotNull('rating')->orderBy('created_at', 'desc')->get();
